defmodule PontinhoWeb.GameViewTest do
  ...
  test "returns the game with a unfinished match" do
    ...
    assert %{
             ...
             betting_table: [10, 10, 10, 10, 10],
             winner_id: nil,
             players: [%{id: nil, name: "Player", points: 99, balance: nil}],
             matches: [
               %{
                 id: nil,
                 croupier: "Player",
  ...
  test "returns the game with a finished match" do
    ...
    assert %{
             ...
             betting_table: [10, 10, 10, 10, 10],
             winner_id: nil,
             players: [%{id: nil, name: "Player", points: 79, balance: nil}],
             matches: [
               %{
                 id: nil,
                 croupier: "Player",
  ...
  test "returns a finished game" do
    player = insert(:player, name: "Player", points: 79, balance: 100)
    ...
    assert %{
             ...
             betting_table: [10, 10, 10, 10, 10],
             winner_id: player.id,
             players: [%{id: player.id, name: "Player", points: 79, playing: true, balance: 100}],
             matches: [
               %{
                 id: match.id,
                 croupier: "Player",
